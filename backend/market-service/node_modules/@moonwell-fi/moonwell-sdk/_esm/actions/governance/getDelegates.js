...
export async function getDelegates(client) {
    ...
    const getUsersPaginated = async (page = 0) => {
        const response = await axios.get(`https://forum.moonwell.fi/directory_items.json?period=all&order=Delegate+Wallet+Address&user_field_ids=2%7C1%7C3&page=${page}`);
...
const getDelegatesExtendedData = async (params) => {
    const response = await axios.post(publicEnvironments.moonbeam.governanceIndexerUrl, {
        query: `
      query {
